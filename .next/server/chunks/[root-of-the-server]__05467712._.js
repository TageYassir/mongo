 ...
 */ async function ensureDbConnected() {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectToDatabase"])();
}
...
async function findUserById(id) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findById(id).lean();
}
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        await ensureDbConnected();
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findByIdAndUpdate(id, data, {
            new: true,
            runValidators: true,
            context: "query"
        }).lean();
...
async function DELETE(request, { params }) {
    ...
    try {
        await ensureDbConnected();
        const removed = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$api$2f$models$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["User"].findByIdAndDelete(id).lean();
        if (!removed) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "User not found"
        }, {
            status: 404
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05467712._.js.map
...
async function loadModels() {
    ...
    return modelsMod?.default || modelsMod || __turbopack_context__.r("[project]/app/api/models.js [app-route] (ecmascript)");
}
    ...
    try {
        ...
        if (operation === 'get-transactions') {
            ...
            const filter = resolvedWalletId ? {
                $or: [
                    {
                        senderWalletId: resolvedWalletId
                    },
                    {
                        receiverWalletId: resolvedWalletId
                    }
                ]
            } : {};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5de81d26._.js.map
...
/** Next Imports */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/navigation.js [app-ssr] (ecmascript)");
...
function RootLayout({ children }) {
    ...
    async function handleLogout() {
        ...
        // Tell the server to mark the user offline (best-effort)
        try {
            if (userId) {
                ...
                // fallback to any session logout endpoint you may have
        ...
        // clear client-side stored user info used by chat/map fallback
        try {
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
        } catch (e) {
        ...
        // Replace current history entry and do a full navigation to /uis.
        // This prevents the usual Back button from returning to the previous page.
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aff39d29._.js.map
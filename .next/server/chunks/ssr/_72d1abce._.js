module.exports = [
"[project]/app/uis/user-space/profile/[id]/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProfilePage() {
    ...
    const idFromRoute = params?.id // correct way for client components to get the dynamic segment
    ;
    ...
    const [relationship, setRelationship] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const getCurrentUserId = async ()=>{
            ...
            try {
                ...
                if (res2.ok) {
                    ...
                    return p2?.user?._id || p2?.user?.id || null;
                }
            } catch (e) {}
            return null;
        };
        ...
        const boot = async ()=>{
            ...
            if (!mounted) return;
            setCurrentUserId(me);
            // use id from the route (must use useParams in client components)
            const targetId = idFromRoute;
            await fetchProfile(targetId);
            // fetch relationship (if we have a current user)
            if (me && targetId) {
                try {
    ...
    const sendRequest = async ()=>{
        ...
        try {
            ...
            // prefer payload.request (API created object), otherwise fall back to the whole payload
            setRelationship(payload.request || payload || null);
        } catch (err) {
    ...
    const respondRequest = async (action)=>{
        ...
        try {
            ...
            setRelationship(payload.request);
        } catch (err) {
    ...
    // - pending && currentUser is sender => show "Request Sent" disabled
    // - pending && currentUser is receiver => show Accept / Refuse buttons
    // - accepted => show "Friends" and Message button
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Stack$2f$Stack$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Stack$3e$__["Stack"], {
                        ...
                        children: relationshipStatus === 'accepted' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$esm$2f$Button$2f$Button$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Button$3e$__["Button"], {
                            variant: "contained",
                            onClick: ()=>router.push(`/uis/chat/${encodeURIComponent(userId)}`),
                            children: "Message"
                        }, void 0, false, {
                            fileName: "[project]/app/uis/user-space/profile/[id]/page.js",
                            lineNumber: 202,
...
//# sourceMappingURL=_72d1abce._.js.map
...
class PointerManager {
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handlePointerEvent", (event)=>{
        ...
        var // User provided root element
        _options_root, _ref;
        this.root = (_ref = (_options_root = options.root) !== null && _options_root !== void 0 ? _options_root : // Fallback to document root or body, this fixes shadow DOM scenarios
        document.getRootNode({
            composed: true
        })) !== null && _ref !== void 0 ? _ref : // Fallback to document body, for some testing environments
        document.body;
        ...
        this.preventEventInterruption = (_options_preventEventInterruption = options.preventEventInterruption) !== null && _options_preventEventInterruption !== void 0 ? _options_preventEventInterruption : true;
...
class Gesture {
   ...
   */ updateOptions(options) {
        ...
        var _options_pointerOptions;
        this.pointerOptions = (_options_pointerOptions = options.pointerOptions) !== null && _options_pointerOptions !== void 0 ? _options_pointerOptions : this.pointerOptions;
    }
    /**
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleOptionsChange", (event)=>{
   ...
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleStateChange", (event)=>{
            if (event && event.detail) {
        ...
        var _options_pointerOptions;
        this.pointerOptions = (_options_pointerOptions = options.pointerOptions) !== null && _options_pointerOptions !== void 0 ? _options_pointerOptions : {};
    }
}
}),
...
class MoveGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
   ...
   * @param event The original pointer event
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleElementEnter", (event)=>{
   ...
   * @param event The original pointer event
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleElementLeave", (event)=>{
            if (event.pointerType !== 'mouse' && event.pointerType !== 'pen') {
                return;
            }
            if (!this.isActive) {
   ...
   * @param event The original pointer event
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handlePointerEvent", (pointers, event)=>{
...
class PanGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    ...
    updateOptions(options) {
        ...
        this.threshold = (_options_threshold = options.threshold) !== null && _options_threshold !== void 0 ? _options_threshold : this.threshold;
    }
    resetState() {
        this.isActive = false;
...
class PressAndDragGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    ...
    updateOptions(options) {
        super.updateOptions(options);
        var _options_pressDuration;
        this.pressDuration = (_options_pressDuration = options.pressDuration) !== null && _options_pressDuration !== void 0 ? _options_pressDuration : this.pressDuration;
        var _options_pressMaxDistance;
        this.pressMaxDistance = (_options_pressMaxDistance = options.pressMaxDistance) !== null && _options_pressMaxDistance !== void 0 ? _options_pressMaxDistance : this.pressMaxDistance;
        var _options_dragTimeout;
        this.dragTimeout = (_options_dragTimeout = options.dragTimeout) !== null && _options_dragTimeout !== void 0 ? _options_dragTimeout : this.dragTimeout;
        var _options_dragThreshold;
        this.dragThreshold = (_options_dragThreshold = options.dragThreshold) !== null && _options_dragThreshold !== void 0 ? _options_dragThreshold : this.dragThreshold;
   ...
   */ constructor(options){
        super(options), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "state", {
            phase: 'waitingForPress',
            dragTimeoutId: null
        }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "pressHandler", ()=>{
        ...
        }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dragStartHandler", (event)=>{
        ...
        }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dragMoveHandler", (event)=>{
            if (this.state.phase !== 'dragging') {
                return;
            }
            // Fire move event
            this.element.dispatchEvent(new CustomEvent((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$utils$2f$createEventName$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createEventName"])(this.name, event.detail.phase), event));
        }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "dragEndHandler", (event)=>{
            if (this.state.phase !== 'dragging') {
                return;
            }
            this.resetState();
        ...
        var _options_pressDuration;
        this.pressDuration = (_options_pressDuration = options.pressDuration) !== null && _options_pressDuration !== void 0 ? _options_pressDuration : 500;
        var _options_pressMaxDistance;
        this.pressMaxDistance = (_options_pressMaxDistance = options.pressMaxDistance) !== null && _options_pressMaxDistance !== void 0 ? _options_pressMaxDistance : 10;
        var _options_dragTimeout;
        this.dragTimeout = (_options_dragTimeout = options.dragTimeout) !== null && _options_dragTimeout !== void 0 ? _options_dragTimeout : 1000;
        var _options_dragThreshold;
        this.dragThreshold = (_options_dragThreshold = options.dragThreshold) !== null && _options_dragThreshold !== void 0 ? _options_dragThreshold : 0;
...
class TapAndDragGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$PointerGesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointerGesture"] {
    ...
    updateOptions(options) {
        super.updateOptions(options);
        var _options_tapMaxDistance;
        this.tapMaxDistance = (_options_tapMaxDistance = options.tapMaxDistance) !== null && _options_tapMaxDistance !== void 0 ? _options_tapMaxDistance : this.tapMaxDistance;
        var _options_dragTimeout;
        this.dragTimeout = (_options_dragTimeout = options.dragTimeout) !== null && _options_dragTimeout !== void 0 ? _options_dragTimeout : this.dragTimeout;
        var _options_dragThreshold;
        this.dragThreshold = (_options_dragThreshold = options.dragThreshold) !== null && _options_dragThreshold !== void 0 ? _options_dragThreshold : this.dragThreshold;
   ...
   */ constructor(options){
        super(options), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "state", {
            phase: 'waitingForTap',
            dragTimeoutId: null
        }), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "tapHandler", ()=>{
        ...
        var _options_tapMaxDistance;
        this.tapMaxDistance = (_options_tapMaxDistance = options.tapMaxDistance) !== null && _options_tapMaxDistance !== void 0 ? _options_tapMaxDistance : 10;
        var _options_dragTimeout;
        this.dragTimeout = (_options_dragTimeout = options.dragTimeout) !== null && _options_dragTimeout !== void 0 ? _options_dragTimeout : 1000;
        var _options_dragThreshold;
        this.dragThreshold = (_options_dragThreshold = options.dragThreshold) !== null && _options_dragThreshold !== void 0 ? _options_dragThreshold : 0;
...
class TurnWheelGesture extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$x$2d$internal$2d$gestures$2f$esm$2f$core$2f$Gesture$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Gesture"] {
   ...
   * @param event The original wheel event
   */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "handleWheelEvent", (event)=>{
            // Check if this gesture should be prevented by active gestures

...
function ProfilePage() {
    ...
    const idFromRoute = params === null || params === void 0 ? void 0 : params.id // correct way for client components to get the dynamic segment
    ;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfilePage.useEffect": ()=>{
            ...
            const getCurrentUserId = {
                "ProfilePage.useEffect.getCurrentUserId": async ()=>{
                    try {
                        const res = await fetch('/api/auth/me');
                        if (res.ok) {
                            var _payload_user, _payload_user1;
                            const payload = await res.json();
                            return (payload === null || payload === void 0 ? void 0 : (_payload_user = payload.user) === null || _payload_user === void 0 ? void 0 : _payload_user._id) || (payload === null || payload === void 0 ? void 0 : (_payload_user1 = payload.user) === null || _payload_user1 === void 0 ? void 0 : _payload_user1.id) || null;
                        }
                    } catch (e) {}
                    try {
                        ...
                        if (res2.ok) {
                            ...
                            return (p2 === null || p2 === void 0 ? void 0 : (_p2_user = p2.user) === null || _p2_user === void 0 ? void 0 : _p2_user._id) || (p2 === null || p2 === void 0 ? void 0 : (_p2_user1 = p2.user) === null || _p2_user1 === void 0 ? void 0 : _p2_user1.id) || null;
                        }
                    } catch (e) {}
                    return null;
                }
            }["ProfilePage.useEffect.getCurrentUserId"];
            const fetchProfile = {
...
_s(ProfilePage, "73AWPbwYDtE7Af9Lv2QUMzji8Sk=", false, function() {
    return [
...
//# sourceMappingURL=_b40688c3._.js.map